...
//        finish();
    ...
    public void onErrorResponse(VolleyError error) {
        stopLoadingStatus();
        Toast.makeText(this, getResources().getString(R.string.inspect_login_fail), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onResponse(RequestWrapper response) {
        ...
        if(response != null && !TextUtils.isEmpty(response.getAeasyapp().getResponseBody().getUuid())){
            ...
            Toast.makeText(this, getResources().getString(R.string.inspect_login_success), Toast.LENGTH_SHORT).show();
            Intent intent = new Intent();
            intent.setClass(LoginActivity.this, HomeActivity.class);
            startActivity(intent);
            finish();
